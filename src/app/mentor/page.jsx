    ...
    if (userEmail && authToken) {
      ...
      const fetchAllData = async () => {
        ...
        try {
          ...
          if (!userRes.ok) throw new Error('Failed to fetch user data enter goals  routesfirst');
          ...
          if (!goalsRes.ok) throw new Error('Failed to fetch goals data  enter goals  routesfirst');
          ...
          if (!leaderboardRes.ok) throw new Error('Failed to fetch leaderboard  enter goals  routesfirst');
