...
[
  {
    ...
    const payloadToServer = {
      ...
      end_goal: "Be able to build a full-stack web application using Node.js and React.",
      daily_tasks: { [today]: newTasks },
      roadmap: goals[activeGoal]?.roadmap || {
        phase1: "Basics: Syntax, Functions, and Objects.",
        phase2: "Asynchronous JavaScript and APIs.",
        phase3: "Frameworks: React and Node.js."
      },
      progress_report: goals[activeGoal]?.progress_report || {
        current_status: "Learning fundamentals and building practical skills."
      },
      xp: totalXpFromTasks,
  ...
  const fetchGoals = async () => {
    ...
    try {
      ...
      // Get difficulty and calculate total XP from the specific goal
  ...
  const judgeAnswer = async (task, date, taskId) => {
    ...
    try {
      ...
      const payloadToServer = {
        goalKeyword: activeGoal,
        end_goal: newGoals[activeGoal].end_goal || "Be able to build a full-stack web application using Node.js and React.",
        ...
        progress_report: newGoals[activeGoal].progress_report || {
          current_status: "Making steady progress with personalized tasks."
        },
        xp: newTotalXp,
